...
# ════════════════════════════════════════════════
#  PERMANENT LIGHT THEME — Dashboard style
# ════════════════════════════════════════════════
BG        = "#f0f2f8"     # page background — cool light grey
BG_CARD   = "#ffffff"     # cards / panels
BG_INPUT  = "#f5f7fc"     # input fields
BG_HOVER  = "#eef0f8"     # hover state
ACCENT    = "#6c63ff"     # purple — primary accent (from reference UI)
ACCENT_L  = "#8b85ff"     # lighter purple for hover
ACCENT_D  = "#6c63ff18"   # dim tint for backgrounds
GREEN     = "#00b894"     # success green
GREEN_D   = "#00b89415"
RED_C     = "#e84393" if False else "#e74c3c"
RED_D     = "#e74c3c15"
YELLOW    = "#f39c12"
YELLOW_D  = "#f39c1215"
TP        = "#1e1e2e"     # text primary — near black
TM        = "#6b7280"     # text muted — grey
BORDER    = "#e2e5f0"     # border colour
BORDER_L  = "#c9cede"
TOPBAR_BG = "#ffffff"
ALT_ROW   = "#f8f9fd"
NET_BG    = "#f3f1ff"     # net card tinted purple
NET_BR    = "#6c63ff"
...
def mk_section(txt):
    l = QLabel(txt.upper())
    l.setStyleSheet(f"color:{TM};font-size:10px;font-weight:700;"
...
class BillingTab(QWidget):
    ...
    def _build_ui(self):
        ...
        def _lfield(label, placeholder, fixed_w=None):
            ...
            lbl.setStyleSheet(f"color:{TM};font-size:9px;font-weight:700;letter-spacing:1px;background:transparent")
        ...
        items_lbl.setStyleSheet(
            f"color:{TM};font-size:10px;font-weight:700;letter-spacing:1.5px;background:transparent")
        ...
        lbl_d.setStyleSheet(f"color:{TM};font-size:9px;font-weight:700;letter-spacing:1px;background:transparent")
        ...
        lbl_pm.setStyleSheet(f"color:{TM};font-size:9px;font-weight:700;letter-spacing:1px;background:transparent")
        ...
        net_lbl.setStyleSheet(f"font-size:9px;font-weight:700;color:{ACCENT};"
                               f"letter-spacing:2px;background:transparent")
        net_lbl.setAlignment(Qt.AlignmentFlag.AlignCenter)
        self.net_display = QLabel("₹ 0.00")
        self.net_display.setStyleSheet(
            f"font-size:20px;font-weight:900;color:{ACCENT};background:transparent")
        self.net_display.setAlignment(Qt.AlignmentFlag.AlignCenter)

        due_lbl = QLabel("DUE")
        due_lbl.setStyleSheet(f"font-size:8px;font-weight:700;color:{RED_C};"
